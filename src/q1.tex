...
\subsection*{d)}
$M_C$ and $M_V$ are, respectively, the conduction band minima and valence band maxima. There values in silicon are $M_C = 3.2$ and $M_V = -0.044$. %\todo[inline]{Explain this}